...
// stack-based algorithm. ansv_left stores indices of
// nearest smaller values to the left in res. -1 means no
// smaller value was found. ansv_right likewise looks to the
// right. v.size() means no smaller value was found.
